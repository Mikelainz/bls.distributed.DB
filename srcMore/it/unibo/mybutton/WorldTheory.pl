%==============================================
% WorldTheory.pl for actor mybutton
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumybutton).	%%old version (deprecated)
actorobj(qatumybutton).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mybutton
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mybutton" ). 
...
%-------------------------------------------------
%  User static rules about mybutton
%------------------------------------------------- 
/*
------------------------------------------------------------------------
