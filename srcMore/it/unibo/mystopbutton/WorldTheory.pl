%==============================================
% WorldTheory.pl for actor mystopbutton
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumystopbutton).	%%old version (deprecated)
actorobj(qatumystopbutton).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mystopbutton
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mystopbutton" ). 
...
%-------------------------------------------------
%  User static rules about mystopbutton
%------------------------------------------------- 
/*
------------------------------------------------------------------------
