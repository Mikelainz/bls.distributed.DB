%==============================================
% WorldTheory.pl for actor mystartbutton
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumystartbutton).	%%old version (deprecated)
actorobj(qatumystartbutton).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mystartbutton
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mystartbutton" ). 
...
%-------------------------------------------------
%  User static rules about mystartbutton
%------------------------------------------------- 
/*
------------------------------------------------------------------------
